...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/shared/shadcn-components/tabs';
...
import { AuthConfigType, AuthType, BodyType, FormDataItemType, ParamItemType } from '@/config/types/api-types';
