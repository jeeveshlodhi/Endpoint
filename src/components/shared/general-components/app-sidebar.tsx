import { Sidebar, SidebarHeader, SidebarMenu, SidebarMenuItem } from '@/components/shared/shadcn-components/sidebar';
...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from '@/components/shared/shadcn-components/dialog';
